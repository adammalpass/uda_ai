...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    #Xi = matrix()
    #Xi.zero(DIMENSIONS,DIMENSIONS)
    
    #Omega.expand(DIMENSIONS, DIMENSIONS, list1, list2 = [])
    ...
    Omega = [[0.0 for row in range(DIMENSIONS)] for col in range(DIMENSIONS)]
    Xi = [[0.0] for row in range(DIMENSIONS)]
